...
fileHandle = open('data/participants.csv', 'r')
...
# Create 150 products 
fileHandle = open('data/products.csv', 'r')
...
fileHandle = open('data/transfers.csv', 'r')
...
# Display the suppply chain tracks we just created
